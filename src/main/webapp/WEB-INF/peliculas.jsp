	...
	<div class="contenido-pelicula">
		<div class="datos-pelicula">
			...
			<div class="boton-pelicula">
				<a
					href="PeliculaSVL?id=<%= pelicula.getId() %>">
					<img src="img/varios/btn-mas-info.jpg" width="120" height="30"
					alt="Ver info" />
				</a>
			</div>
			<div class="boton-pelicula">
				<a href="http://www.cinestar.com.pe/popups/trailer/<%= pelicula.getLink() %>"
		...
		<img src="img/pelicula/<%= pelicula.getId() %>.jpg" width="160" height="226" /><br />
		<br />
	</div>
